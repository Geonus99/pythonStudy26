...
from LMS.common import Session # 로그인한 member 개체
    ...
    def view_all(cls):
        ...
        try:
            with conn.cursor() as cursor:
                ...
                """
                cursor.execute(sql)
                datas = cursor.fetchall() # .fetchall()은 모든 값
