...
# DTO (Data Transfer Object, 데이터전송 객체)
...
class Member: # 클래스는 무조건! 대문자로 시작하세요!!!
    ...
    # 사용법 member = Member()
    # member.to_line() -> kkw|1234|김기민|admin|True엔터
    # 메모장에 객체 기록용!
    ...
    # 사용법 : m = Member(uid, pw , name, role, active) -> 권장하지 않음 왜냐면 객체에다 바로 꽂는거 별로여서 메서드를 통해 넣는게 좋음
    #         self를 사용하는 방법 (객체 변수)
    ...
    # 면접시 물어보는 내용!!!
    # 직렬화, 역직렬화
    # 직렬화(Serialization) : 객채 -> 저장 가능한 형태
    #       member.to_line()
